...
static void sender(sg4::Mailbox *  mail_box,const std::string message)
{
	//sg4::Mailbox * mail_box = sg4::Mailbox::by_name(mailbox_name);
...
int main(int argc, char* argv[])
{
  ...
  sg4::Mailbox * mail_box = sg4::Mailbox::by_name("Ehab Saleh");
 sg4::Actor::create("actor_0",host_0, sender,mail_box,"A message");
